...
# saved_dir = '/GPFS/zhuqingjie/dataset_saved/tunet_onesample/os'
#
...
def handle():
    ...
    return_x = os.path.join(tmpdir, 'os_7x.bmp')
    return_predict = os.path.join(tmpdir, 'os_7predict.bmp')
    return_y = os.path.join(tmpdir, 'os_7y.bmp')
